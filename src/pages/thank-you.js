...
const TYPage = () => (
  <LPLayout>
    <section className="container mx-auto my-8 lg:mt-20 px-4 md:w-1/2 h-full">
      ...
      <p>Look for the subject line: <span className="font-semibold text-center">[Welcome!] Your M. Boris short story download links …</span></p>
      ...
      <div className="hidden"> {/* figure out upsell offer & redo this section */}
